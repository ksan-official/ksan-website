...
type EditablePost = {
  ...
  department: string | null; description: string; employment_type: string | null; featured: boolean;
    ...
    try {
      ...
      const response = await fetch("/api/admin/business", {
        body: JSON.stringify({
          ...
          company: formData.get("company"), deadline: formData.get("deadline"), department: formData.get("department"),
  ...
  return (
    <main className="page" id="main">
      ...
      <form className="form" onSubmit={submit}>
        ...
        <label className="field"><span>상세 설명</span><textarea defaultValue={post.description} name="description" required rows={6} /></label>
        <div className="admin-two-column">
