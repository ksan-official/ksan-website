      ...
      {guide ? (
        <section className="admin-editor-layout">
          <form className="admin-form" onSubmit={submit}>
            ...
            <label className="field">
              <span>카테고리</span>
              <input name="category" defaultValue={guide.category} />
            </label>
            <label className="field">
              <span>요약</span>
            ...
            <label className="field">
              <span>작성자</span>
              <input name="author" defaultValue={guide.author ?? "KSAN"} />
            </label>
            <label className="field">
              <span>태그</span>
              <input name="tags" defaultValue={(guide.tags ?? []).join(", ")} />
            </label>
